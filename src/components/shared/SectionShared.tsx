export type Section = "home" | "firstaid" | "emergency" | "diseases" | "rashes" | "contacts";
...
export const rashPhotos = [
  {
    ...
    action: "Не расчёсывать. Зелёнка или каламин на пузырьки. К врачу при высокой температуре > 3 дней.",
  },
  {
    label: "Краснуха",
